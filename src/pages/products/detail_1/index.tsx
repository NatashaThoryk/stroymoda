		...
		<>
			...
			<main className={classes.main}>
				...
				<div className={classes.section_bg}>
					<SectionBlockLeft slides={slides4 as any} customClass="container" btnName="Learn more" title="Pop Up seating" text1="Pop up seating is available for floor integration and for integration on retractable platforms . It creates a flat floor configuration or a flexible tribune that transforms from a pop up seating system into a rigid bleacher."/>
				</div>
					<SectionBlockRight slides={slides5 as any} btnName="View all" title="Armchairs for halls and public venues" text1="Jezet seats are used as theater armchair conference armchair and auditorium armchair. All models are available as fixed armchair and retractable armchair system for telescopic tribunes"/>
			</main>
