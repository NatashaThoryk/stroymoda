	...
	return (
		<>
			...
			<main className={classes.main}>
				...
				<SustainabilityMainBlock src="/img/sustainability/bamboo.svg"
				...
				<SustainabilityMainBlock src="/img/sustainability/pefc.svg"
